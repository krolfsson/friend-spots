...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  sv: {
    ...
    "home.mockup.caption": "Platshållare för Mac och iPhone — byt till era skärmdumpar när ni är klara.",
  ...
  en: {
    ...
    "home.mockup.caption": "Placeholders for Mac and iPhone — swap in your screenshots when ready.",
